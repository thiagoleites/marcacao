      ...
      <div class="card tile is-child">
        <div class="card-content">
          <div class="level is-mobile">
            ...
            <div class="level-item has-widget-icon">
              <div class="is-widget-icon"><span class="icon has-text-info is-large"><i class="mdi mdi-account-clock mdi-48px"></i></span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="card tile is-child">
        <div class="card-content">
          <div class="level is-mobile">
            ...
            <div class="level-item has-widget-icon">
              <div class="is-widget-icon"><span class="icon has-text-success is-large"><i class="mdi mdi-clipboard-plus mdi-48px"></i></span>
              </div>
            </div>
          </div>
        </div>
